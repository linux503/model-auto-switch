...
echo "   访问: http://127.0.0.1:8090/skills/model-auto-switch/scripts/model_web_dashboard_enhanced.html"
echo ""
echo "3. 配置定时任务:"
echo "   crontab -e"
echo "   添加: */5 * * * * /Users/a404/.openclaw/workspace/skills/model-auto-switch/scripts/model_auto_switch.sh"
echo ""
echo "4. 测试完整功能:"
